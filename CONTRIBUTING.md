...
The project is MIT licensed. Target changes to the next unreleased version documented in `CHANGELOG.md`.
...
- Discuss broader alert types against the roadmap before expanding the supported event set.
